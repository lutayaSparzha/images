...
<?php if($currentUser): ?>
<h5>Friends, who are also following <?php Html::encode($user->username); ?></h5>
<div class="row">
    <?php foreach ($currentUser->getMutalSubscriptionsTo($user) as $item): ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <?php foreach ($user->getSubscriptions() as $subscriptions): ?>
                <div class="col-md-12">
                    <a href="<?php echo Url::to(['/user/profile/view', 'nickname' => ($subscriptions['nickname']) ? $subscriptions['nickname'] : $subscriptions['id']]); ?>">
                       <?php echo Html::encode($subscriptions['username']); ?>
                    </a>   
                </div>
            <?php endforeach;?>  
        </div>      
